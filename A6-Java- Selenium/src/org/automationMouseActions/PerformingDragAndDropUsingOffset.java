...
public class PerformingDragAndDropUsingOffset {
	...
	driver.findElement(By.xpath
			("//input[contains(@placeholder,'Search') and @aria-label]")).sendKeys("Mobiles", Keys.ENTER);
	
	Thread.sleep(5000);
	   WebElement slider = driver.findElement(By.xpath
			("(//div[text()=' Price ']/../..//div[@class='vue-slider-dot-handle'])[1]"));
